...
import pandas as pd
import pydeequ
from oss_data_quality_frameworks_compare.dq_with_pydeequ import (
    data_quality as pydq_data_quality,
)
from oss_data_quality_frameworks_compare.dq_with_soda_core import (
    data_quality as sc_data_quality,
)
...
def run_dq_check_soda_core(spark) -> tuple[dict, int]:
    ...
    result_dict, exit_code = sc_data_quality.soda_core_constraint_verification(
        spark=spark, df_name="sklearn_housing"
    )
